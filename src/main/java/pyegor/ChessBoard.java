...
public class ChessBoard {
    ...
    public boolean castling0() {
        if (nowPlayer.equals("White")) {
            if (new King("White").isUnderAttack(this, 0,4) || board[0][0] == null || board[0][4] == null){
                System.out.println("Король под шахом или клетки для рокировок пусты");
                return false;
            }
            ...
            if (new King("Black").isUnderAttack(this, 7, 0)||board[7][0] == null || board[7][4] == null) {
                System.out.println("Король под шахом или клетки для рокировок пусты");
                return false;
            }
    ...
    public boolean castling7() {
        if (nowPlayer.equals("White")) {
            if (new King("White").isUnderAttack(this, 0,4) || board[0][7] == null || board[0][4] == null) {
                System.out.println("Король под шахом или клетки для рокировок пусты");
                return false;
            }
            ...
            if (new King("Black").isUnderAttack(this, 7, 4)|| board[7][0] == null || board[7][4] == null) {
                System.out.println("Король под шахом или клетки для рокировок пусты");
                return false;
            }
