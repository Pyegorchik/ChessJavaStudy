...
//     public boolean canCastle(boolean isKingSide, boolean kingMoved, boolean rookMoved, boolean isCheck) {
//         if (kingMoved || rookMoved || isCheck) {
//             return false;
//         }
//         // Дополнительные проверки, такие как:
//         // - Свободны ли клетки между королем и ладьей
//         // - Находятся ли эти клетки под шахом
//         return true;
//     }

//     public void castle(boolean isKingSide) {
//         if (canCastle(isKingSide, kingMoved, rookMoved, isCheck)) {
//             if (isKingSide) {
//                 System.out.println("Рокировка на королевский фланг выполнена.");
//             } else {
//                 System.out.println("Рокировка на ферзевый фланг выполнена.");
//             }
//             kingMoved = true;
//         } else {
...
//         game.castle(true); // Пример вызова рокировки
//     }
// }
